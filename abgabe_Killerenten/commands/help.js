...
module.exports = {
    ...
    execute(message, args, client) {
        ...
        const messageembedhelpadmin = new MessageEmbed()
            ...
            .addField('!config/!c', '!config setzt mit annid welcomeid ping die Channel id bzw Rolle für die welcome message bzw announcements bzw für gepingte user fest, mit application und opencreate lassen sich dann mit true und false die Anmeldung und die Teamerstellung freischalten. Außerdem lässt sich mit **!config logid** die channeld-id für den bot log ändern. Anschließen lässt sich der bot mit **!restart** restarten.', true)
